  ...
  return (
    <div className="resume-view">
      <div className="resume-download">
        <div><strong>Resume downloads</strong><span>Choose the complete record or a concise professional version.</span></div>
        <div className="resume-download-actions">
          <a href="/downloads/adrian-sizemore-resume-brief-2026.pdf" download>Brief resume <small>PDF</small></a>
          <a href="/downloads/adrian-sizemore-resume-2026.pdf" download>Complete resume <small>PDF</small></a>
        </div>
      </div>
      {data.profile && (
